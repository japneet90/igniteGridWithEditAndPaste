...
@Component({
  selector: 'app-grid-partial',
  templateUrl: './grid-partial.component.html',
  styleUrls: ['./grid-partial.component.scss']
})
export class GridPartialComponent implements OnInit {
  @Input() inputGridList: any;
  @Input() inputGridColumns: any;
  @Input() allowPaging: any;
  @Input() allowFilter: any;
  @Input() allowPasting: any;
